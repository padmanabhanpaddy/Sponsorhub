            ...
            {/* List of items */}
            {
              ...
              (user_email || sponsor_email)?(
                <ul>
                  ...
                  {user_email&&<Link to="/user_events"><li>Sponsor Status</li></Link>}
                  {user_email&&<Link to="/event_post"><li>Post Event</li></Link>}


                  {sponsor_email&&<Link to="/sponsor_events"><li>Sponsor Status</li></Link>}

                  <Link to="/"><li onClick={handleSignout}>Signout</li></Link>
                  
                </ul>
              ) : (
                <ul>
                  <Link to="/"><li>Home</li></Link>
                  <Link to="/sponsor_signin"><li>Sponsor Signin</li></Link>
                  <Link to="/sponsor_signup"><li>Sponsor Signup</li></Link>
                  <Link to="/user_signin"><li>User Signin</li></Link>
                  <Link to="/user_signup"><li>User Signup</li></Link>
                </ul>
              )
            }
